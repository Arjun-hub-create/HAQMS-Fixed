...
export const AuthProvider = ({ children }) => {
  ...
  // FIX: Use NEXT_PUBLIC_ environment variable instead of hardcoded localhost URL.
  ...
  const login = async (email, password) => {
    ...
    try {
      ...
      // Note: localStorage is acceptable for this SPA context.
      // For higher security, consider httpOnly cookies via a backend session endpoint.
